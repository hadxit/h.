...
-- ------------------------------------------------
    ...
    EXCEPTION
        WHEN OTHERS THEN
          raise_application_error(-20001,'Undefined error occured in loadSystemCache_weigth');
    ...
    BEGIN
       ...
       -- key is c_km2
       h$cache.addChildObject(l_sys_col,h$constants.c_ft2,'1','10763910.4');
       h$cache.addChildObject(l_sys_col,h$constants.c_yd2,'2','1195990.05');
       h$cache.addChildObject(l_sys_col,h$constants.c_m2, '3','1000000');
       h$cache.addChildObject(l_sys_col,h$constants.c_a,  '4','10000');
       h$cache.addChildObject(l_sys_col,h$constants.c_ac, '5','247.105381');
       h$cache.addChildObject(l_sys_col,h$constants.c_ha, '6','100');        
       h$cache.addChildObject(l_sys_col,h$constants.c_km2,'7','1');      
    ...
    BEGIN
       ...
       -- key is c_cc
       h$cache.addChildObject(l_sys_col,h$constants.c_cc, '1','764554.858');
       h$cache.addChildObject(l_sys_col,h$constants.c_ml ,'2','764554.858');
       h$cache.addChildObject(l_sys_col,h$constants.c_cm3,'3','764554.858');
       h$cache.addChildObject(l_sys_col,h$constants.c_in3,'4','46656');
       h$cache.addChildObject(l_sys_col,h$constants.c_oz, '5','25852.6749');
       h$cache.addChildObject(l_sys_col,h$constants.c_dl, '6','7645.54858');        
       h$cache.addChildObject(l_sys_col,h$constants.c_l,  '7','764.554858');    
       h$cache.addChildObject(l_sys_col,h$constants.c_gal,'8','201.974026');    
       h$cache.addChildObject(l_sys_col,h$constants.c_ft3,'9','27');    
       h$cache.addChildObject(l_sys_col,h$constants.c_l,  '10','4.811547');    
       h$cache.addChildObject(l_sys_col,h$constants.c_yd3,'11','1');    
       h$cache.addChildObject(l_sys_col,h$constants.c_m3 ,'12','0.764555');    
    ...
    BEGIN
       ...
       -- key is c_c
       h$cache.addChildObject(l_sys_col,h$constants.c_k, '1','274.15');
       h$cache.addChildObject(l_sys_col,h$constants.c_f ,'2','33.8');
       h$cache.addChildObject(l_sys_col,h$constants.c_c ,'3','1');
    ...
    BEGIN
       ...
       -- key is c_mpa
       h$cache.addChildObject(l_sys_col,h$constants.c_dyne   ,'1','10000000'); 
       h$cache.addChildObject(l_sys_col,h$constants.c_pa     ,'2','1000000');
       h$cache.addChildObject(l_sys_col,h$constants.c_mmh2o  ,'3','101971.626');
       h$cache.addChildObject(l_sys_col,h$constants.c_hpa    ,'4','10000');
       h$cache.addChildObject(l_sys_col,h$constants.c_mb     ,'5','10000');
       h$cache.addChildObject(l_sys_col,h$constants.c_mmhg   ,'6','7500.61683');
       h$cache.addChildObject(l_sys_col,h$constants.c_inchh2o,'7','4014.62805');
       h$cache.addChildObject(l_sys_col,h$constants.c_kpa    ,'8','1000');
       h$cache.addChildObject(l_sys_col,h$constants.c_inchhg ,'9','295.299875');
       h$cache.addChildObject(l_sys_col,h$constants.c_psi   ,'10','145.038243');
       h$cache.addChildObject(l_sys_col,h$constants.c_kgf   ,'11','10.1971626');
       h$cache.addChildObject(l_sys_col,h$constants.c_bar   ,'12','10');
       h$cache.addChildObject(l_sys_col,h$constants.c_atm   ,'13','9.869233');       
       h$cache.addChildObject(l_sys_col,h$constants.c_mpa   ,'14','1');
    ...
    BEGIN
       ...
       -- key is c_mi_s
       h$cache.addChildObject(l_sys_col,h$constants.c_in_h   ,'1','228096000'); 
       h$cache.addChildObject(l_sys_col,h$constants.c_ft_h   ,'2','19008000');
       h$cache.addChildObject(l_sys_col,h$constants.c_m_h    ,'3','5793638.4');
       h$cache.addChildObject(l_sys_col,h$constants.c_in_s   ,'4','63360');
       h$cache.addChildObject(l_sys_col,h$constants.c_km_h   ,'5','5793.6384');
       h$cache.addChildObject(l_sys_col,h$constants.c_ft_s   ,'6','5280');
       h$cache.addChildObject(l_sys_col,h$constants.c_mi_h   ,'7','3600');
       h$cache.addChildObject(l_sys_col,h$constants.c_kn     ,'8','3128.31447');
       h$cache.addChildObject(l_sys_col,h$constants.c_m_s    ,'9','1609.344');
       h$cache.addChildObject(l_sys_col,h$constants.c_mach  ,'10','4.733365');
       h$cache.addChildObject(l_sys_col,h$constants.c_km_s  ,'11','1.609344');   
       h$cache.addChildObject(l_sys_col,h$constants.c_mi_s  ,'12','1');
    ...
    BEGIN
       ...
       -- key is c_eb
       h$cache.addChildObject(l_sys_col,h$constants.c_bit ,'1','9223372036854780000'); 
       h$cache.addChildObject(l_sys_col,h$constants.c_b   ,'2','1152921504606850000');
       h$cache.addChildObject(l_sys_col,h$constants.c_kb  ,'3','1125899906842620');
       h$cache.addChildObject(l_sys_col,h$constants.c_mb  ,'4','1099511627776');
       h$cache.addChildObject(l_sys_col,h$constants.c_gb  ,'5','1073741824');
       h$cache.addChildObject(l_sys_col,h$constants.c_tb  ,'6','1048576');
       h$cache.addChildObject(l_sys_col,h$constants.c_pb  ,'7','1024');
       h$cache.addChildObject(l_sys_col,h$constants.c_eb  ,'8','1');
    ...
    BEGIN
       ...
       -- key is c_DD
       h$cache.addChildObject(l_sys_col,h$constants.c_SS ,'1','86400'); 
       h$cache.addChildObject(l_sys_col,h$constants.c_MI ,'2','1440');
       h$cache.addChildObject(l_sys_col,h$constants.c_HH ,'3','24');
       h$cache.addChildObject(l_sys_col,h$constants.c_DD ,'4','1');
